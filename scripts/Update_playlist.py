...
OUTPUT_DIR = "scripts"
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "Finalplay04.m3u")
...
def process_playlist(source_file, output_file):
    ...
    try:
        ...
        WELCOME_MESSAGE = [
            f'#EXTINF:-1 tvg-logo="{NEW_LOGO_URL}" group-title="00_Welcome RAFKI", 🎉 Selamat Datang di Playlist RAFKI 🎶 | Nikmati hiburan terbaik & jangan lupa subscribe YouTube kami! 📺',
...
commit_msg = f"Update Finalplay04 otomatis - {datetime.utcnow().isoformat()} UTC"
